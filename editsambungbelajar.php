    ...
    if (!empty($_FILES["profileImage"]["name"])) {
        ...
        if (move_uploaded_file($_FILES["profileImage"]["tmp_name"], $target_file)) {
            ...
            if (mysqli_query($connect, $updateQuery)) {
                header('Location: sambungbelajar.php');
            } else {
...
$query = mysqli_query($connect, "SELECT * FROM sambungbelajar WHERE noIc = '$noIc'");
...
<option name="5m3">5 Mekanikal 3</option>
                ...
                <tr>
                    ...
                    <td>
                       <input type="int" id="tahunmasuk" name="tahunmasuk" class="inputkohort"  value=" <?php echo isset($fetch["tahunmasuk"]) ? $fetch["tahunmasuk"] : ''; ?>" required>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                       <input type="int" id="tahuntamat" name="tahuntamat" class="inputkohort"  value=" <?php echo isset($fetch["tahuntamat"]) ? $fetch["tahuntamat"] : ''; ?>" required>
                    </td>
                </tr>
        ...
        <button class="buttonsave" name="submit" type="submit" style="margin: 20px auto;"><b>SAVE</b></button>
    </td>
