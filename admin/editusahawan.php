...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_FILES["profileImage"]["name"])) {
        ...
        if (move_uploaded_file($_FILES["profileImage"]["tmp_name"], $target_file)) {
            $updateQuery = "UPDATE usahawan SET
...
if (isset($_GET['noIc'])) {
    ...
    $query = "SELECT * FROM usahawan WHERE noIc = '$noIcFromURL'";
        ...
        <table cellspacing="0" cellpadding="5">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="alamatkerja" name="alamatkerja" class="inputalamatkerja"  value="<?php echo isset($fetch["alamatkerja"]) ? $fetch["alamatkerja"] : ''; ?>" required>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="alamatrumah" name="alamatrumah"  class="inputalamatrumah"  value="<?php echo isset($fetch["alamatrumah"]) ? $fetch["alamatrumah"] : ''; ?>" required>
                    </td>
                </tr>
                        <tr>
                            <td colspan="8">
