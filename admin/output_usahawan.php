...
if (isset($_GET['noIc'])) {
    ...
    $query = "SELECT usahawan.*, user.*
              FROM usahawan
              JOIN user ON usahawan.noIc = user.noIc
              WHERE usahawan.noIc = '$noIcFromURL'";
    ...
    <body class="bgmpusahawan">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <table width="100%">
                <tr>
                    <td class="titlemp">
                        <h1 style="margin-right: 15px;"><u>Maklumat Anda</u></h1>
                    </td>
                </tr>
            ...
            <form method="post" >
                ...
                <tr>
                    <td colspan="8">
                   <button class="buttonusahawan"><b><a style="text-decoration: none; color: black;" href="editusahawan.php?noIc=<?php echo $fetch['noIc']; ?>">EDIT</a></b></button>
                     </td>
                </tr>
                <tr>
                    <tr></tr>
