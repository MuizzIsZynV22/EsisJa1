...
$query = mysqli_query($connect, "SELECT usahawan.*, user.* FROM usahawan
                                  JOIN user ON usahawan.noIc = user.noIc
                                  WHERE usahawan.noIc = '$noIc'");
...
<html>
    ...
    <body class="bgmpusahawan">
        ...
        <form method="post" enctype="multipart/form-data">
            <table cellspacing = "0" cellpadding="5">
                ...
                <tr>
                    ...
                    <td class="welcomemp">
                        <h1 class="usahawan">Selamat Datang <?php echo isset($fetch["nama"]) ? $fetch["nama"] : ''; ?></a> ! </h1>
                    </td>
                    <td class=logout>
        ...
        <button class="buttonusahawan"><b><a style="text-decoration: none; color: black;" href="editusahawan.php">EDIT</a></b></button>
